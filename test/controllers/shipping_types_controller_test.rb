...
class ShippingTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_type" do
    assert_difference("ShippingType.count") do
      post shipping_types_url, params: { shipping_type: { code: @shipping_type.code, name: @shipping_type.name } }
    end
  ...
  test "should update shipping_type" do
    patch shipping_type_url(@shipping_type), params: { shipping_type: { code: @shipping_type.code, name: @shipping_type.name } }
