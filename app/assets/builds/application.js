...
%o`, message, error2, detail);
  ...
  var country_controller_default = class extends Controller {
    connect() {
    }
    change(event) {
  ...
  application.register("country", country_controller_default);
  application.register("hello", hello_controller_default);
  application.register("search", search_controller_default);
  application.register("state", state_controller_default);
